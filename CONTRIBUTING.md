...
Please **do not** file public issues for security vulnerabilities. Email bosejijo@gmail.com directly with details, and we'll respond within 72 hours.
...
```bash
git clone https://github.com/<your-fork>/errsight-community.git
