class OrganizationsController < ApplicationController
  ...
  def activate
    ...
    if org
      ...
      # Land on the dashboard so the whole page re-renders in the newly active
      # org's context. Staying on the previous page (redirect_back) could leave
      # the user on a resource that belongs to the org they just switched away from.
