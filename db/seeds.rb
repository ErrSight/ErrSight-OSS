...
#
# If those vars are not set, the seed runs as a no-op. Public signup is
# disabled by default (ALLOW_PUBLIC_SIGNUP=false), so the seed is the
# recommended way to bootstrap the first admin on a fresh install.
